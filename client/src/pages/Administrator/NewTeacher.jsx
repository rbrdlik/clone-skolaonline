  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result && result.status === 201) {
        setSuccess("Učitel byl úspěšně vytvořen");
        setTitle("");
        setFirstName("");
        setLastName("");
        setUsername("");
        ...
        setError(result?.message || "Chyba při vytváření učitele");
      }
    } catch (err) {
      setError("Chyba při vytváření učitele");
      ...
      <main className="main-content">
        <section className="form-card">
          ...
          <div className="card-body">
            <form className="teacher-grid-form" onSubmit={handleSubmit}>
